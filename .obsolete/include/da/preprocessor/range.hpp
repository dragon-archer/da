...
#define DA_RANGE_STANDARDIZE_1(x) (0, DA_TUPLE_HEAD(x), 1)
#define DA_RANGE_STANDARDIZE_2(x) (DA_TUPLE_HEAD(x), DA_TUPLE_GET(1, x), 1)
#define DA_RANGE_STANDARDIZE_3(x) x

#define DA_RANGE_START(x) DA_TUPLE_HEAD(x)
