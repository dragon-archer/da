 ...
 */
#define DA_ADD(x, y) DA_TUPLE_HEAD(DA_WHILE(DA_ADD_P, DA_ADD_O, (x, y)))
#define DA_ADD_P(d)  DA_TUPLE_GET(1, d)
#define DA_ADD_O(d)  (DA_INC(DA_TUPLE_HEAD(d)), DA_DEC(DA_TUPLE_GET(1, d)))
 ...
 */
#define DA_SUB(x, y) DA_TUPLE_HEAD(DA_WHILE(DA_SUB_P, DA_SUB_O, (x, y)))
#define DA_SUB_P(d)  DA_TUPLE_GET(1, d)
#define DA_SUB_O(d)  (DA_DEC(DA_TUPLE_HEAD(d)), DA_DEC(DA_TUPLE_GET(1, d)))
